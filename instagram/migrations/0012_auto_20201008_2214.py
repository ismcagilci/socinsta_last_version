# Generated by Django 2.2 on 2020-10-08 19:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('instagram', '0011_auto_20201004_1710'),
    ]

    operations = [
        migrations.CreateModel(
            name='Instagram_Api_User_Agent',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('android_version', models.IntegerField(default=24, verbose_name='Android version')),
